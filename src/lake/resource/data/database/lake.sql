...
CREATE TABLE `pre__lakeadmin_attachment` (
  ...
  `type_id` varchar(32) DEFAULT '0' COMMENT '关联类型ID',
  ...
  `listorder` smallint(5) NOT NULL DEFAULT '100' COMMENT '排序',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态',
...
INSERT INTO `pre__lakeadmin_admin` VALUES (1,'admin','1e1a7700b24fdf7328f349aa5e99a2aa','DYHGJk','管理员','lake-admin@qq.com','6faa1b979521721a1927ca75703141d2',1,1,1598971846,1270,1564667925,'2130706433'),(2,'lake','dbe97f21a69f67fb361b0be64988ee59','T3qf8f','Lake','lake@qq.com','b7daae912526add9c6929568ec929313',0,1,1577596275,2130706433,1564415458,'2130706433');
INSERT INTO `pre__lakeadmin_attachment` VALUES ('6faa1b979521721a1927ca75703141d2','admin','admin',1,'Koala.jpg','/storage/images/20200226/f955a044e579fc624a9d97fd5ee0cdc3.jpg','','','image/jpeg','jpg',780831,'2b04df3ecc1d94afddff082d139c6f15','9c3dcb1f9185a314ea25d51aed3b5881b32f420c','local',100,1,1582706063,1582705793,0,''),('b7daae912526add9c6929568ec929313','admin','admin',1,'Penguins.jpg','/storage/images/20200226/9865b6472adb90e60b405a7818f61fd0.jpg','','','image/jpeg','jpg',777835,'9d377b10ce778c4938b3c7e2c63a229a','df7be9dc4f467187783aca68c7ce98e4df2172d0','local',100,1,1582706529,1582705839,0,'');
