...
CREATE TABLE `pre__lakeadmin_event` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '事件点名称，为英文',
  `class` text CHARACTER SET utf8mb4 NOT NULL COMMENT '事件类',
  `description` mediumtext CHARACTER SET utf8mb4 COMMENT '事件点描述',
